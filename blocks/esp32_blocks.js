...
Blockly.Blocks['text_append'] = {
    init: function () {
        this.setColour(OPERATORS_HUE);
        this.appendDummyInput().appendField("to").appendField(new Blockly.FieldVariable("var"), "VAR").appendField("append text");
        this.appendValueInput("TEXT").setCheck("String");
        this.setInputsInline(true);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip("Append text to a variable.");
    }
};
...
Blockly.Blocks['text_indexOf'] = {
    init: function () {
        ...
        this.appendValueInput("FIND").setCheck("String").appendField("find").appendField(new Blockly.FieldDropdown([["first", "FIRST"], ["last", "LAST"]]), "END").appendField("occurrence of text");
        this.setInputsInline(true);
        this.setOutput(true, "Number");
        this.setTooltip("Find position of text within another text.");
    }
};
...
Blockly.Blocks['text_charAt'] = {
    init: function () {
        this.setColour(OPERATORS_HUE);
        this.appendValueInput("VALUE").setCheck("String").appendField("in text");
        this.appendDummyInput().appendField("get").appendField(new Blockly.FieldDropdown([["letter #", "FROM_START"], ["letter # from end", "FROM_END"], ["first letter", "FIRST"], ["last letter", "LAST"], ["random letter", "RANDOM"]]), "WHERE");
        this.appendValueInput("AT").setCheck("Number");
        this.setInputsInline(true);
        this.setOutput(true, "String");
        this.setTooltip("Get a character from text.");
    }
};
...
Blockly.Blocks['text_getSubstring'] = {
    init: function () {
        ...
        this.appendDummyInput().appendField("get substring from").appendField(new Blockly.FieldDropdown([["letter #", "FROM_START"], ["letter # from end", "FROM_END"], ["first letter", "FIRST"]]), "WHERE1");
        this.appendValueInput("AT1").setCheck("Number");
        this.appendDummyInput().appendField("to").appendField(new Blockly.FieldDropdown([["letter #", "FROM_START"], ["letter # from end", "FROM_END"], ["last letter", "LAST"]]), "WHERE2");
        this.appendValueInput("AT2").setCheck("Number");
        this.setInputsInline(true);
        this.setOutput(true, "String");
        this.setTooltip("Get substring of text.");
    }
};
...
Blockly.Blocks['text_changeCase'] = {
    init: function () {
        this.setColour(OPERATORS_HUE);
        this.appendDummyInput().appendField("to").appendField(new Blockly.FieldDropdown([["UPPER CASE", "UPPERCASE"], ["lower case", "LOWERCASE"], ["Title Case", "TITLECASE"]]), "CASE");
        this.appendValueInput("TEXT").setCheck("String");
        this.setInputsInline(true);
        this.setOutput(true, "String");
        this.setTooltip("Change the case of text.");
    }
};
...
Blockly.Blocks['text_trim'] = {
    init: function () {
        this.setColour(OPERATORS_HUE);
        this.appendDummyInput().appendField("trim spaces from");
        this.appendValueInput("TEXT").setCheck("String");
        this.setInputsInline(true);
        this.setOutput(true, "String");
        this.setTooltip("Remove leading/trailing spaces from text.");
    }
};

// ── casting_to_char ──────────
Blockly.Blocks['casting_to_char'] = {
    init: function () {
        this.setColour(OPERATORS_HUE);
        this.appendDummyInput().appendField("Casting to char");
        this.appendValueInput("VALUE").setCheck("Number");
        this.setInputsInline(true);
        this.setOutput(true, "String");
        this.setTooltip("Cast a number to a char character.");
    }
};
...
Blockly.Blocks['convert_to_string'] = {
    init: function () {
        this.setColour(OPERATORS_HUE);
        this.appendDummyInput().appendField("Convert to String");
        this.appendValueInput("VALUE");
        this.setInputsInline(true);
        this.setOutput(true, "String");
...
// ── convert_to_string_decimal ──────────
Blockly.Blocks['convert_to_string_decimal'] = {
    init: function () {
        this.setColour(OPERATORS_HUE);
        this.appendDummyInput().appendField("Convert to String");
        this.appendValueInput("VALUE").setCheck("Number");
        this.appendDummyInput().appendField("Number of decimals").appendField(new Blockly.FieldNumber(5, 0, 10), "DECIMALS");
        this.setInputsInline(true);
        this.setOutput(true, "String");
        this.setTooltip("Convert a number to String with N decimal places.");
    }
};

// ── custom_text_value (string literal) ──────────
Blockly.Blocks['custom_text_value'] = {
    init: function () {
        ...
        this.setOutput(true, "String");
        this.setTooltip("A text string literal.");
    }
};